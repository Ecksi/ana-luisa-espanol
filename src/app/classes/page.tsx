...
const ranks = [
  {
    ...
    role: "Great for those new to Spanish",
  ...
  },
  {
    ...
    role: "Good for those who know the basics",
    email: "janecooper@example.com",
    telephone: "+1-202-555-0170",
    imageUrl:
      "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=60",
  ...
  },
  {
    ...
    role: "Learn Spanish anywhere in the world",
    email: "janecooper@example.com",
    telephone: "+1-202-555-0170",
    imageUrl:
      "https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=4&w=256&h=256&q=60",
  ...
  return (
    <Card>
      <div className="mb-6 flex justify-center items-center space-x-3">
        <Image
          src={ecuaPeople[0].src}
          alt={ecuaPeople[0].alt}
